...
export default function CardapioPratosPrincipaisComponent(){
    return (
        <>
            <CardLista titulo="Pratos Principais" layout={CardListaTiposLayout.Vertical} itens={bebidas.map(bebida => `${bebida.descricao} . . . ${bebida.preco.toLocaleString('pt-br', {style: 'currency', currency: 'BRL'})}`)}/>
        </>
    )
}