...
export default function CardapioEntradasComponent(){
    return (
        <>
            <CardLista titulo="Entradas" layout={CardListaTiposLayout.Vertical} itens={bebidas.map(bebida => `${bebida.descricao} . . . ${bebida.preco.toLocaleString('pt-br', {style: 'currency', currency: 'BRL'})}`)}/>
        </>
    )
}